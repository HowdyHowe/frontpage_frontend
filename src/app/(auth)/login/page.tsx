    ...
    return (
        <div className="flex flex-col-reverse items-center justify-center w-full h-full lg:flex-row">
            ...
            <form  className="flex flex-col w-[90%]">
                    ...
                    <input type="text"  className="w-full h-[50px] p-3 border-[2px] rounded-lg placeholder:text-sm placeholder:lg:text-lg placeholder:text-[#64748B]" placeholder="Input Username"/>
                    ...
                    <div className="flex flex-row items-center w-full h-[50px] border-[2px] rounded-lg">
                        <input type={visible ? "text": "password"} className="w-full h-full p-3 bg-transparent placeholder:text-sm placeholder:lg:text-lg placeholder:text-[#64748B]" placeholder="Input Password"/>
